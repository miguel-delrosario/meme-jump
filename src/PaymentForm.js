...
export default class PaymentForm extends Component {
	...
	componentDidMount() {
		const config = {
			applicationId: "sandbox-sq0idp-vtrV9emWDOm6ZVw8IE_1bg",
			locationId: "CBASEF2WVthJyqTejYWrIhtD8VggAQ",
			inputClass: "sq-input",
			autoBuild: false,
			inputStyles: [
				{
	...
	render() {
		return (
			<div className="container modal payment-form">
				<div id="form-container modal payment-form">
					<div id="sq-walletbox">
						<button
					...
					<div id="sq-ccbox">
						<p>
							<span style={styles.title}>Unlock Super Speed! </span>
							<br/>
					...
					<button
						className="button-credit-card button-cancel"
